...
(function(jQuery) {
    ...
    jQuery(document).ready(function() {
       ...
       -----------------------------------------------------------------------*/
        ...
        -----------------------------------------------------------------------*/
        let options = {
            damping: 0.1,  // Scroll damping effect
            renderByPixels: true,  // Render by pixels
        ...
        * -----------------------------------------------------------------*/
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener("submit", function(event) {
                ...
                // Stuur de inloggegevens naar de backend
                fetch("http://localhost:5000/login", { // Vervang dit met de URL van je backend
                    method: "POST",
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        // Bij succesvolle inlog doorverwijzen naar een nieuwe pagina
                        window.location.href = "/dashboard"; // Vervang met je targetpagina
                    } else {
                        // Toon een foutmelding bij mislukte inlog
